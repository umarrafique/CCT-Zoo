...
public class Aquatic extends Animal implements AnimalInterface{
    
    //creating variable for Aquatic(Special Field)
    
    int swimingheight;
    public int getSwimmingHeight(){
    return this.swimingheight;
    }
    public void setSwimmingHeight(int height){
    this.swimingheight=height;
    }
   ...
   @Override
    ...
    public String toString() {
        return "Animal Type = " + this.GetType() + "\n"
                ...
                + "Swimming Depth = " + this.getSwimmingHeight() + "\n"
